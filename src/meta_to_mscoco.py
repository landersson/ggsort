...
def main():
    ...
    parser.add_argument('--input', '-i', required=True, help='Input JSON file in custom format')
    parser.add_argument('--output', '-o', required=True, help='Output JSON file in MSCOCO format')
    parser.add_argument('--image-dir', '-d', help='Directory containing images (for getting dimensions)')
